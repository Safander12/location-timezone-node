# location-timezone-node <!-- omit in toc -->
...
`npm install --save location-timezone-node`
...
```javascript
import locationTimezone from 'location-timezone-node';

const locationTimezone = require('location-timezone-node');
```
